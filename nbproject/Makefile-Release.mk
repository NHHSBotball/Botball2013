...
${OBJECTDIR}/motor-test.o: motor-test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/motor-test.o motor-test.c
...
${OBJECTDIR}/scooper-main.o: scooper-main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/scooper-main.o scooper-main.c

${OBJECTDIR}/scooper-scoop-utils.o: scooper-scoop-utils.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/scooper-scoop-utils.o scooper-scoop-utils.c

${OBJECTDIR}/sorter-drive-utils.o: sorter-drive-utils.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sorter-drive-utils.o sorter-drive-utils.c

${OBJECTDIR}/sorter-main.o: sorter-main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sorter-main.o sorter-main.c
